...
const crearCaja=(url,nombre,precio,categoria,id)=>{
   ...
   caja.classList.add("producto_caja_caja");
    ...
    <a href="../../html/homeLogin/login.html?id=${id}&tipo=accesorio&btn=delete">
    ...
    <a href="../../html/homeLogin/login.html?id=${id}&tipo=accesorio&btn=update">
...
const contenedor1=document.querySelector("[data-accesorio]");
